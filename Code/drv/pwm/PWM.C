...
//	if(PWM == PWMA)
	{
		PWMA_Duty1(PWMx->PWM1_Duty + 64);
		PWMA_Duty2(PWMx->PWM2_Duty + 64);
		PWMA_Duty3(PWMx->PWM3_Duty + 64);
		PWMA_Duty4(PWMx->PWM4_Duty + 64);
	}
//	else
//	{
//		PWMB_Duty5(PWMx->PWM5_Duty);
...
void PWM_config(void)
{
	...
	PWMx_InitStructure.PWM_Period   = 2551;							//周期时间,   0~65535
	...
	PWMx_InitStructure.PWM_PS_SW       = PWM1_SW_P10_P11| PWM2_SW_P12_P13 | PWM3_SW_P14_P15 | PWM4_SW_P16_P17;	//切换端口,		PWM1_SW_P10_P11,PWM1_SW_P20_P21,PWM1_SW_P60_P61
